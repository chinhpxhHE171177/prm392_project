...
import com.example.workforcemanagement.data.repository.ScheduleRepositoryHR;
...
public class ScheduleViewModel extends AndroidViewModel {
    private final ScheduleRepositoryHR repository;
    ...
    public ScheduleViewModel(@NonNull Application application, User user) {
        ...
        this.repository = new ScheduleRepositoryHR(tokenManager);
    }
