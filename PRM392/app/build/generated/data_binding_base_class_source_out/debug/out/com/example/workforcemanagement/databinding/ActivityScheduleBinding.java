...
public final class ActivityScheduleBinding implements ViewBinding {
  ...
  private ActivityScheduleBinding(@NonNull CoordinatorLayout rootView, @NonNull Button btnAdd,
      @NonNull LinearLayout headerLayout, @NonNull ImageView ivBack,
  ...
  public static ActivityScheduleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityScheduleBinding((CoordinatorLayout) rootView, btnAdd, headerLayout, ivBack,
          recyclerView);
    }
